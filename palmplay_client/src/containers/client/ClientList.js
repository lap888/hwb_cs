 ...
 * @Last Modified time: 2019-05-04 00:59:51
 */
...
class Client extends React.Component {
    ...
    renderClientList () {
        const columns = [{
            ...
            fixed: 'left',
            render: (text, record) => (
                <a onClick={() => this.props.router.push({ pathname: `/clientinfo/${record['userId']}` })}>{record['nickname']}</a>
            ),
        },{
            title: "用户ID",
            dataIndex: 'userId',
            ...
            width: "150px",
            render: (text, record) => (
                <a onClick={() => this.props.router.push({ pathname: `/clientinfo/${record['inviterUserId']}` })}>{text}</a>
            ),
        },{
            title: "钻石余额",
            dataIndex: 'gem',
            ...
            width: "150px",
            render: (text, record) => (
                <p style={{ margin: 0 }}>{record['freezeGem']}</p>
            )
        },{
            title: "分红余额",
            ...
            width: "150px",
            render: (text, record) => (
                <p style={{ margin: 0 }}>{`¥${(record['balanceNormal'] + record['balanceLock'])}`}</p>
            )
        },{
            title: "分红可提现",
            ...
            width: "150px",
            render: (text, record) => (
                <p style={{ margin: 0 }}>{`¥${record['balanceNormal']}`}</p>
            )
        },{
            title: "分红冻结",
            ...
            width: "150px",
            render: (text, record) => (
                <p style={{ margin: 0 }}>{`¥${record['balanceLock']}`}</p>
            )
        },{
            title: "注册时间",
